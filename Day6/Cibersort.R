...
ggsave("Histogram.pdf", hg, width = 12, height = 8)
...
ggsave("Ordered_boxplot.pdf", lg, width = 10, height = 8)
...
pdf("H_Map.pdf", width = 10, height = 10)
hp <- heatmap(V, col=col, symm=TRUE,  xlab = "Genes", ylab = "Genes", main = "Correlation_HeatMap(Hie)", margins = c(10, 10))
dev.off()
